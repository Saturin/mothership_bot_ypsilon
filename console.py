...
Deycard = ["REMOVE SONYA KEYCARD", "REMOVE KEYCARD", "TAKE OUT KEYCARD", "take out keycard", "remove sonya keycard",
           "remove keycard", "Remove Keycard", "Remove Sonya Keycard"]
Lock1 = ["Unlock 1", "UNLOCK 1", "1"]
Scuttle = ["SCUTTLE", "Scuttle", "scuttle"]
Life = ["Life Support", "LIFE SUPPORT", "life support", "Life support"]
Comms = ["Comms", "COMMS", "comms"]
Heracles = ["Heracles", "HERACLES", "heracles", "HAIL RSV THE HERACLES", "Hail RSV The Heracles",
            "hail rsv the heracles", "HAIL HERACLES", "hail heracles"]
Grasshopper = ["GRASSHOPPER", "Grasshopper", "grasshopper", "HAIL IMV GRASSHOPPER", "Hail IMV Grasshopper",
               "hail imv grasshopper", "HAIL GRASSHOPPER", "hail grasshopper"]
End = ["END", "END CALL", "End", "End Call", "end", "end call", "End call"]
Download = ["DOWNLOAD", "Download", "download"]
UnlockDock1 = ["UNLOCK DOCK 1", "unlock dock 1", "UNLOCK DOCKING BAY 1", "Unlock docking bay 1", "unlock 1", "UNLOCK 1",
               "UNLOCK ONE", "unlock docking bay 1"]
UnlockDock2 = ["UNLOCK DOCK 1", "unlock dock 2", "UNLOCK DOCKING BAY 2", "Unlock docking bay 2", "unlock 2", "UNLOCK 2",
               "UNLOCK TWO", "unlock docking bay 2"]
LockDock1 = ["LOCK DOCK 1", "lock dock 1", "LOCK DOCKING BAY 1", "lock docking bay 1", "LOCK 1", "lock 1", "LOCK ONE",
             "lock docking bay 1"]
LockDock2 = ["LOCK DOCK 2", "lock dock 2", "LOCK DOCKING BAY 2", "lock docking bay 2", "LOCK 2", "lock 2", "LOCK TWO",
             "lock docking bay 2"]
LockMine = ["LOCK MINESHAFT", "lock mineshaft", "Lock Mineshaft", "Lock mineshaft", "LOCK MINE", "lock mine",
            "Lock Mine", "Lock mine", "MINE LOCK"]
UnlockMine = ["UNLOCK MINESHAFT", "unlock mineshaft", "Unlock Mineshaft", "Unlock mineshaft", "UNLOCK MINE",
              "unlock mine", "Unlock Mine", "Unlock mine", "MINE UNLOCK"]
...
Dry3 = ["SHOWER 3 OFF", "3 OFF", "3 off", "THREE OFF", "Shower 3 off", "shower 3 off", "three off", "Three off",
        "OFF THREE"]
Dry4 = ["SHOWER 4 OFF", "4 OFF", "4 off", "FOUR OFF", "Shower 4 off", "shower 4 off", "four off", "Four off",
        "OFF FOUR"]
Dry5 = ["SHOWER 5 OFF", "5 OFF", "5 off", "FIVE OFF", "Shower 5 off", "shower 5 off", "five off", "Five off",
        "OFF FIVE"]
EnableAll = ["LOCK ALL", "lock all", "Lock All", "Lock all", "ALL ON", "ON ALL", "all on", "All on", "on all",
             "TURN ALL ON", "TURN ALL", "turn all on", "turn all", "ENABLE ALL", "enable all", "Enable All",
             "Enable all"]
DisableAll = ["UNLOCK ALL", "unlock all", "Unlock All", "Unlock all", "ALL OFF", "OFF ALL", "all off", "All off",
              "off all", "TURN ALL OFF", "turn all off", "DISABLE ALL", "disable all", "Disable All", "Disable all"]
